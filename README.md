...
- Download CMU-1.tif from https://drive.google.com/file/d/15zgeD9_liFZrJ_HSgWxfoPiuPqm9vJ7d/view?usp=sharing. Make sure you store the image on a fast drive such as an SSD. NOTE: MAKE SURE YOUR BROWSER DOWNLOADS THE FILE AS A .TIF. Some end up downloading as .svs, which may give issues during the test.
